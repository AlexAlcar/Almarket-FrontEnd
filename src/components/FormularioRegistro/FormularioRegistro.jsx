          ...
          <div className="card">
            <form onSubmit={handleSubmit(onSubmit)} className="p-fluid">
              <div className="field">
                <span className="p-float-label">
                  <Controller
                    name="nombre"
                    control={control}
                    rules={{ required: "Debes introducir un nombre" }}
              ...
              <div className="field">
                <span className="p-float-label">
                  <Controller
                    name="apellido1"
                    control={control}
                    rules={{ required: "Debes introducir un apellido." }}
                    render={({ field, fieldState }) => (
                      <InputText
                        id={field.apellido1}
                        {...field}
              ...
              <div className="field">
                <span className="p-float-label p-input-icon-right">
                  ...
                  <Controller
                    ...
                    control={control}
                    rules={{
                      required: "Debes introducir una dirección de correo electrónico.",
                      pattern: {
                        value: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i,
                        message: "Introduce una dirección válida. Ej. example@email.com",
                      },
                    }}
                    render={({ field, fieldState }) => (
                      <InputText
              ...
              <div className="field">
                <span className="p-float-label">
                  <Controller
                    name="direccion"
                    control={control}
                    rules={{ required: "Debes introducir la dirección." }}
                    render={({ field, fieldState }) => (
                      <InputText
                        id={field.direccion}
                        {...field}
              ...
              <Divider align="center">
                <ToggleButton
                  checked={toggleUser}
                  onChange={(e) => setToggleUser(!toggleUser)}
                  onLabel="Usuario impresor"
                  offLabel="Usuario normal"
                  style={{ width: "10em", backgroundColor: "#883cae" }}
                />
              </Divider>
              {toggleUser ? (
                <>
                  <div className="field-impresores" style={{}}>
                    <p className="p-float-label">Nº de impresoras</p>
                    <InputNumber
                      inputId="horizontal"
                      className="field-impresores-input"
                      style={{ width: "30%" }}
                  ...
                  <div className="field-impresores">
                    <p className="p-float-label" style={{}}>
                      Tamaño máximo
                    </p>
              ...
              <div className="field">
                ...
                <span className="p-float-label">
                  <Controller
                    name="password"
                    control={control}
                    rules={{ required: "Debes introducir una contraseña." }}
                    render={({ field, fieldState }) => (
                      <Password
                        id={field.name}
                        {...field}
