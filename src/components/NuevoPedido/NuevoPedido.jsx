            ...
            <div className="card">
                <div className="p-fluid formgrid grid">
                    <div style={{ float: 'left', marginLeft: '20%' }}>
                        ...
                        <label htmlFor="date">Tamaño:</label><br />
                        <InputNumber
                            inputId="minmax-buttons"
                            mode="decimal"
                            showButtons
                    ...
                    <div style={{ float: 'right', marginRight: '20%' }}>
                        ...
                        <Dropdown options={["PLA", "PETG", "FilaFlex", "ABS"]}
                            style={{ width: '200px' }}
                    ...
                    <div style={{ float: 'bottom' }}>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                {ficheroSubido ? <p><i className="pi pi-check-circle"></i> Modelo 3D subido correctamente</p>
                                    : <>
